  ...
  const getThumbnailImage = () => {
    ...
    <div>
      ...
      <p className="mt-1 text-sm">
        {product?.ratingPoint !== undefined ? product?.ratingPoint : 'N/A'}
      </p>
    </div>;
    return (
      thumbnail?.imageUrl ||
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="flex items-center justify-between border rounded-lg p-3">
                      ...
                      <Badge
                        variant={product.isOnline ? 'default' : 'secondary'}>
                        {formatBoolean(product.isOnline)}
                      </Badge>
                    </div>
                    <div className="flex items-center justify-between border rounded-lg p-3">
                      <label className="text-sm font-medium">POS</label>
                      <Badge variant={product.isPos ? 'default' : 'secondary'}>
                    ...
                    <div className="flex items-center justify-between border rounded-lg p-3">
                      ...
                      <Badge
                        variant={product.isPreOrder ? 'default' : 'secondary'}>
                    ...
                    <div className="flex items-center justify-between border rounded-lg p-3">
                      ...
                      <Badge
                        variant={product.isOfficial ? 'default' : 'secondary'}>
                    ...
                    <div className="flex items-center justify-between border rounded-lg p-3">
                      ...
                      <Badge
                        variant={
                          product.freeShipping ? 'default' : 'secondary'
                        }>
                    ...
                    <div className="flex items-center justify-between border rounded-lg p-3">
                      ...
                      <Badge variant={product.isEmi ? 'default' : 'secondary'}>
                      ...
                      <div className="grid grid-cols-4 gap-3">
                        {getGalleryImages().map((img, idx) => (
                          <div
                            ...
                            <Image
                              src={
                                img.imageUrl || img.url || '/placeholder.svg'
                              }
                                ...
                                <table className="w-full text-sm border rounded-lg">
                                  ...
                                  <tbody>
                                    {network.defaultStorages.map(storage => (
                                      <tr
                                        key={storage.id}
                                        className="border-b hover:bg-muted/20 last:border-0">
                                      ...
                                      color.storages && (
                                        <div className="mt-2 space-y-1 text-xs">
                                          ...
                                          {color.storages.map(s => (
                                            <div
                                              key={s.id}
                                              className="flex justify-between border-b border-dashed pb-1 mb-1 last:border-0">
                                              <span>{s.storageSize}</span>
                                              <span className="font-medium">
                                                {formatPrice(
                                                  s.price?.discountPrice || 0,
                                                )}
                                              </span>
                                            </div>
                                          ))}
